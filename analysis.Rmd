...
```{r, fig.width=8, fig.height=20}
  ...
  renderMap(figF, title="Major cause of fatalities by state", 
  ...
  renderMap(figI, title="Major cause of injuries by state", 
  ...
  renderMap(figP, title="Major cause of property damage by state", 
  ...
  renderMap(figC, title="Major cause of crop damage by state", 
